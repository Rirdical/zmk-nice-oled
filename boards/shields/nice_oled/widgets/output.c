...
static void draw_usb_connected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_image(canvas, CONFIG_NICE_OLED_WIDGET_OUTPUT_USB_CUSTOM_X, CONFIG_NICE_OLED_WIDGET_OUTPUT_USB_CUSTOM_Y, &usb, &img_dsc);
}
...
static void draw_ble_unbonded(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_image(canvas, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_UNBONDED_CUSTOM_X, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_UNBONDED_CUSTOM_Y, &bt_unbonded, &img_dsc);
}
#endif
...
static void draw_ble_disconnected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_image(canvas, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_CUSTOM_X, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_CUSTOM_Y, &bt_no_signal, &img_dsc);
}
...
static void draw_ble_connected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_image(canvas, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_CUSTOM_X, CONFIG_NICE_OLED_WIDGET_OUTPUT_BT_CUSTOM_Y, &bt, &img_dsc);
}
